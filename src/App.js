    ...
    <div className="wrapper clear">
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          <div className="card">
            <img src="/img/sneakers/sneaker-1.png" alt="sneaker" />
          ...
          <div className="card">
            <img src="/img/sneakers/sneaker-2.png" alt="sneaker" />
          ...
          <div className="card">
            <img src="/img/sneakers/sneaker-5.png" alt="sneaker" />
            <h5>Nike Blazer Mid Suede Men's Sneakers</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Price:</span>
          ...
          <div className="card">
            <img src="/img/sneakers/sneaker-6.png" alt="sneaker" />
            <h5>Download Puma X Aka Boku Future Rider</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Price:</span>
                <strong>1000 $</strong>
